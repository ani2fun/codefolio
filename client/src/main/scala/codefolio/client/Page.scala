...
/** All routes the SPA knows about. The router picks one based on the URL.
  *
  * Path-parameter cases (`Chapter`, `BookRedirect`, `BlogPost`) are case
  * classes so scalajs-react's `caseClass[…]` Router DSL can pack/unpack them.
  */
sealed trait Page

object Page:
  case object Home                                            extends Page
  case object KnowledgeIndex                                  extends Page
