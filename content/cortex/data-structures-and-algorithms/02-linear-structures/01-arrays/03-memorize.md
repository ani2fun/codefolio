...
> 🖼 Diagram — three frames: empty 1D array of size five, one element written in the middle, and a fully populated 2D `3 × 4` grid that exposes both row-major (across) and column-major (down) walks.
