...
- [Introduction to Backtracking](/cortex/data-structures-and-algorithms/algorithms-by-strategy-backtracking-introduction-to-backtracking) — what backtracking is, the three components every solution carries, the state space tree, the phone-PIN warm-up.
- [Pattern: Unconditional Enumeration](/cortex/data-structures-and-algorithms/algorithms-by-strategy-backtracking-pattern-unconditional-enumeration) — every leaf is a solution; no pruning. Subsets, sequences, phone-keypad combinations.
- [Pattern: Conditional Enumeration](/cortex/data-structures-and-algorithms/algorithms-by-strategy-backtracking-pattern-conditional-enumeration) — pruning by constraint. Balanced parentheses, target-sum combinations, IP-address generation, permutations.
- [Pattern: Backtracking Search](/cortex/data-structures-and-algorithms/algorithms-by-strategy-backtracking-pattern-backtracking-search) — mutate the world; propagate true on success; undo on failure. Maze pathfinding, word search, N-queens, sudoku.
