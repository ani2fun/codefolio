...
The walker on the Scala side lives in [ChapterContent.scala](https://github.com/aniketkakde/codefolio/blob/main/client/src/main/scala/codefolio/client/components/knowledge/ChapterContent.scala). The relevant shape is:
